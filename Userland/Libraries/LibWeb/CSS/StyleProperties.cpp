...
CSS::ContentData StyleProperties::content() const
{
    ...
    if (value->is_content()) {
        ...
        for (auto const& item : content_style_value.content().values()) {
            if (item->is_string()) {
                builder.append(item->as_deprecated_string().string_value());
            } else {
        ...
        if (content_style_value.has_alt_text()) {
            ...
            for (auto const& item : content_style_value.alt_text()->values()) {
                if (item->is_string()) {
                    alt_text_builder.append(item->as_deprecated_string().string_value());
                } else {
...
String StyleProperties::grid_area() const
{
    ...
    return value->as_deprecated_string().string_value();
}
